    ...
    return (
        <div className='ds-m-50'>
            <Row className='ds-justify-center'>
                <Text text={<TbError404 /> as unknown as string} className='ds-text-error700 ds-text-size-100' />
            </Row>
            <Row className='ds-justify-center'>
                <Text text='Page non trouvée !' className="ds-text-neutral700" type={TextType['type-4']} />
            </Row>
